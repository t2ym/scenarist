...
if ((typeof window === 'undefined' ? 'undefined' : _typeof(window)) !== 'object') {
  global.TestX = function (_ExampleSuite) {
    _inherits(TestX, _ExampleSuite);

    function TestX() {
      _classCallCheck(this, TestX);

      return _possibleConstructorReturn(this, (TestX.__proto__ || Object.getPrototypeOf(TestX)).apply(this, arguments));
    }
...
}
{
            ...
            while (1) {
              switch (_context11.prev = _context11.next) {
                case 0:
                  ...
                  child = element.querySelector('div');
                  _context11.next = 6;
                  return regeneratorRuntime.awrap(this.forEvent(element, 'click', function () {
                ...
                case 6:
                  ...
                  _context11.next = 10;
                  return regeneratorRuntime.awrap(this.forEvent(element, 'click', null, true));
                ...
                case 10:
                  ...
                  _context11.next = 13;
                  return regeneratorRuntime.awrap(this.forEvent(element, 'click', null, false));
  ...
  example.test = t = function (_ExampleSuite2) {
    _inherits(TestC, _ExampleSuite2);
  ...
  example.test = t = function (_ExampleSuite3) {
    _inherits(TestD, _ExampleSuite3);
  ...
  example.test = t = function (_ExampleSuite4) {
    _inherits(TestE, _ExampleSuite4);
